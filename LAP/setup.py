...
def main_setup():
    ...
    # Seeded binding
    seeded_pyx = os.path.join(package_path, "_seeded_jv.pyx")
    seeded_cpp = compile_cpp(seeded_pyx)
    ...
    ext_modules = [
        ...
        Extension(
            name='lap._seeded_jv',
            sources=[seeded_cpp, os.path.join(_lapjv_src, "lapjv_seeded.cpp"), lapjvcpp],
            include_dirs=[include_numpy(), _lapjv_src, package_path],
        ),
    ]
